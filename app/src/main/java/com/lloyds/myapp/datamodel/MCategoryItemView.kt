...
data class MCategoryItemView(
    @SerializedName("meals")
    var meals: MutableList<MealItemRecipe> = arrayListOf()
)

data class MealItemRecipe(
    ...
    // This function allows access the fields using reflection
    ...
    fun getMeasurement(index: Int): String? {
        return when (index) {
            1 -> strMeasure1
            2 -> strMeasure2
            3 -> strMeasure3
